...
//  PUT /users/:id  (update self)
export const updateProfile = async (
  userId: number,
  payload: Partial<Pick<User, "fullname" | "phone" | "designation">>,
): Promise<void> => {
  await apiClient.put<BackendResponse<null>>(`/users/${userId}`, payload);
};
